...
'''
inputstr =  """5 2
AAGAATTAAAAGTTCACGTTTGTCA
CTAAAGTGAGTTTGCCGTCCATGTC
AAGTTGTTATCTGGGTCTAATGGTC
TATGTACGTTCCTTTCCGATTAAGA
TAACCGAGCTTACGACGGCTATGTT
AAGTAGCGACTAATTATACATCCTA"""
        ...
        for kmer in allKmersOf(my_str,k):
            ...
            for dkmer in dkmers:
                if isMotif(dkmer,dna_strings,d):
                    my_kmers.add(dkmer)
    print(" ".join([kmer for kmer in my_kmers]))
